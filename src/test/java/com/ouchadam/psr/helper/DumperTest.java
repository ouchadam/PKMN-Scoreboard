...
public class DumperTest {
    ...
    private static final PokemonFile LINUX_STATE = FileHelper.loadState("linux_save1.sgm");
    private static final PokemonFile WINDOWS_STATE = FileHelper.loadState("save1.sgm");
...
//        Dumper.dumpMoney(WINDOWS_STATE, new Money("999999"));
        // 0x56bf   0xa96f
    }
...
//        Dumper.dumpPlaytime(WINDOWS_STATE, new Playtime(255, 0, 0));
    ...
    public void match_os_values() {
        ...
        PokemonFile windows = FileHelper.loadState("save1.sgm");
        PokemonFile linux = FileHelper.loadState("linux_save1.sgm");
